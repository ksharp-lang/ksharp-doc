...
more about [modules](0005-modules.mdx)
...
more about [annotations](0004-annotations.mdx)
...
more about [type system](0001-typesystem.mdx)
...
more about [functions](0002-functions.mdx)
...
1. [literals](0006-literals.mdx)
2. [if expressions](0007-if-expr.mdx)
3. [let expressions](0010-let-expression.mdx)
4. [match expressions](0011-match-expressions.mdx)
...
more about [match expressions](0009-match-assigment.mdx)
